...
/// Class mocked UADSInterstitialAd.
@property(nonatomic, nonnull) id interstitialAdClassMock;

/// Class mocked UADSRewardedAd.
@property(nonatomic, nonnull) id rewardedAdClassMock;

/// Class mocked UADSBannerAd.
@property(nonatomic, nonnull) id bannerAdClassMock;
